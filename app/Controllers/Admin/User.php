...
class User extends BaseController
{
    ...
    /* dashboard */
        public function dashboard()
        {
            ...
            if ($userType == 'MA') {
                ...
                for ($i = 0; $i <= 13; $i++) {
                    ${"bugArray$i"} = $this->common_model->find_data('ecomm_enquires', 'array', ['status' => $i], 'id,sl_no,plant_id');
        ...
        public function dashboardFilter()
        {
            ...
            if ($userType == 'MA') {
                ...
                $data['step5_count']                = $this->common_model->find_data('ecomm_enquires', 'count', ['status' => 5, 'updated_at>=' => $fDate, 'updated_at<=' => $tDate]);
                $data['step6_count']                = $this->common_model->find_data('ecomm_enquires', 'count', ['status' => 6, 'updated_at>=' => $fDate, 'updated_at<=' => $tDate]);
                $data['step7_count']                = $this->common_model->find_data('ecomm_enquires', 'count', ['status' => 7, 'updated_at>=' => $fDate, 'updated_at<=' => $tDate]);
                $data['step8_count']                = $this->common_model->find_data('ecomm_enquires', 'count', ['status' => 8, 'updated_at>=' => $fDate, 'updated_at<=' => $tDate]);
                $data['step9_count']                = $this->common_model->find_data('ecomm_enquires', 'count', ['status' => 9, 'updated_at>=' => $fDate, 'updated_at<=' => $tDate]);
                $data['step10_count']               = $this->common_model->find_data('ecomm_enquires', 'count', ['status' => 10, 'updated_at>=' => $fDate, 'updated_at<=' => $tDate]);
                $data['step11_count']               = $this->common_model->find_data('ecomm_enquires', 'count', ['status' => 11, 'updated_at>=' => $fDate, 'updated_at<=' => $tDate]);
                $data['step12_count']               = $this->common_model->find_data('ecomm_enquires', 'count', ['status' => 12, 'updated_at>=' => $fDate, 'updated_at<=' => $tDate]);
                $data['step13_count']               = $this->common_model->find_data('ecomm_enquires', 'count', ['status' => 13, 'updated_at>=' => $fDate, 'updated_at<=' => $tDate]);
                $orderBy[0]                         =  ['field' => 'id', 'type' => 'DESC'];
                $data['recent_enquiries']           = $this->common_model->find_data('ecomm_enquires', 'array', ['status!=' => 14, 'created_at>=' => $fDate, 'created_at<=' => $tDate], '', '', '', $orderBy, 10);
            } elseif ($userType == 'U') {
                $data['plant']                      = $this->common_model->find_data('ecomm_users', 'count', ['status!=' => 3, 'type' => 'PLANT', 'created_at>=' => $fDate, 'created_at<=' => $tDate]);
                $data['enquiry']                    = $this->common_model->find_data('ecomm_enquires', 'count', ['status!=' => 14, 'created_at>=' => $fDate, 'created_at<=' => $tDate]);
                $data['pendingItem']                = $this->common_model->find_data('ecomm_enquiry_products', 'count', ['status' => 0, 'created_at>=' => $fDate, 'created_at<=' => $tDate]);
                ...
                $data['step0_count']                = $this->common_model->find_data('ecomm_enquires', 'count', ['status' => 0, 'company_id' => $company_id, 'updated_at>=' => $fDate, 'updated_at<=' => $tDate]);
                $data['step1_count']                = $this->common_model->find_data('ecomm_enquires', 'count', ['status' => 1, 'company_id' => $company_id, 'updated_at>=' => $fDate, 'updated_at<=' => $tDate]);
                $data['step2_count']                = $this->common_model->find_data('ecomm_enquires', 'count', ['status' => 2, 'company_id' => $company_id, 'updated_at>=' => $fDate, 'updated_at<=' => $tDate]);
                $data['step3_count']                = $this->common_model->find_data('ecomm_enquires', 'count', ['status' => 3, 'company_id' => $company_id, 'updated_at>=' => $fDate, 'updated_at<=' => $tDate]);
                $data['step4_count']                = $this->common_model->find_data('ecomm_enquires', 'count', ['status' => 4, 'company_id' => $company_id, 'updated_at>=' => $fDate, 'updated_at<=' => $tDate]);
                $data['step5_count']                = $this->common_model->find_data('ecomm_enquires', 'count', ['status' => 5, 'company_id' => $company_id, 'updated_at>=' => $fDate, 'updated_at<=' => $tDate]);
                $data['step6_count']                = $this->common_model->find_data('ecomm_enquires', 'count', ['status' => 6, 'company_id' => $company_id, 'updated_at>=' => $fDate, 'updated_at<=' => $tDate]);
                $data['step7_count']                = $this->common_model->find_data('ecomm_enquires', 'count', ['status' => 7, 'company_id' => $company_id, 'updated_at>=' => $fDate, 'updated_at<=' => $tDate]);
                $data['step8_count']                = $this->common_model->find_data('ecomm_enquires', 'count', ['status' => 8, 'company_id' => $company_id, 'updated_at>=' => $fDate, 'updated_at<=' => $tDate]);
                $data['step9_count']                = $this->common_model->find_data('ecomm_enquires', 'count', ['status' => 9, 'company_id' => $company_id, 'updated_at>=' => $fDate, 'updated_at<=' => $tDate]);
                $data['step10_count']                = $this->common_model->find_data('ecomm_enquires', 'count', ['status' => 10, 'company_id' => $company_id, 'updated_at>=' => $fDate, 'updated_at<=' => $tDate]);
                $data['step11_count']                = $this->common_model->find_data('ecomm_enquires', 'count', ['status' => 11, 'company_id' => $company_id, 'updated_at>=' => $fDate, 'updated_at<=' => $tDate]);
                $data['step12_count']                = $this->common_model->find_data('ecomm_enquires', 'count', ['status' => 12, 'company_id' => $company_id, 'updated_at>=' => $fDate, 'updated_at<=' => $tDate]);
                $data['step13_count']                = $this->common_model->find_data('ecomm_enquires', 'count', ['status' => 13, 'company_id' => $company_id, 'updated_at>=' => $fDate, 'updated_at<=' => $tDate]);
                $orderBy[0]                         =  ['field' => 'id', 'type' => 'DESC'];
                $data['recent_enquiries']           = $this->common_model->find_data('ecomm_enquires', 'array', ['status!=' => 14, 'company_id' => $company_id, 'created_at>=' => $fDate, 'created_at<=' => $tDate], '', '', '', $orderBy, 10);
            }
            echo $this->layout_after_login($title, $page_name, $data);
        }
    /* dashboard */
    ...
    /* test email */
        public function testEmail()
        {
            ...
            // try {
            //     $test =  send_mail('shubhadip.sinha@keylines.net', $subject, $message);
            //     var_dump($test);
            // } catch (\Exception $e) {
            //     pr('Error Sending Test Email: ' . $e->getMessage());
            // }
    ...
    /* ecoex certificates */
        public function ecoexCertificates()
        {
            ...
            echo $user_id                    = $this->session->get('company_id');
