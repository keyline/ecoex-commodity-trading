    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <?php if($common_model->checkModuleFunctionAccess(8,32)){?>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <?php } else { ?>
                                                <img src="<?= getenv('app.NOIMAGE') ?>" alt="<?= $row->name ?>" class="img-thumbnail" style="width: 100px; height: auto; margin-top: 10px;">
                                            <?php } ?>
                                        </td>
                                        <td>
                                            <h6>
                                        ...
                                        <td width="12%" class="text-center">
                                            <?php if($common_model->checkModuleFunctionAccess(8,35)){?>
                                            ...
                                            <?php }?>
                                            <?php if($common_model->checkModuleFunctionAccess(8,34)){?>
                                            ...
                                            <?php }?>
                                            <?php if($row->status){?>
                                                <?php if($common_model->checkModuleFunctionAccess(8,33)){?>
                                                ...
                                                <?php }?>
                                            <?php } else {?>
                                                <?php if($common_model->checkModuleFunctionAccess(8,31)){?>
