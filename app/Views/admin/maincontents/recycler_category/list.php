                    ...
                    <div class="card-body">
                        <?php if ($common_model->checkModuleFunctionAccess(19, 92)) { ?>
                            <h5 class="card-titles">
                                <a href="<?= base_url(route_to('recycler_category.create')) ?>" class="btn btn-outline-success btn-sm">Add New</a>
                            </h5>
                        <?php } ?>
                        <?php if (!empty($rows)) { ?>
                                        ...
                                        if (!empty($rows)): $sl = 0 ?>
                                            <?php foreach ($rows as $row): ?>
                                                <tr>
                                                    ...
                                                    <td style="max-width: 200ch; word-wrap: break-word; white-space: normal;"> <?= $row->category_name ?> </td>
