            ...
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-body pt-3">
                        <form method="POST" action="<?= base_url(route_to('recycler_category.store')) ?>" enctype="multipart/form-data">
                            <input type="hidden" name="update_id" value="<?= $updateId ?>">


                            <!-- Name Input Tags -->
                            <div class="row mb-3">
                                <label for="input-tags" class="col-md-2 col-lg-2 col-form-label"> Name</label>
                            ...
                            <div class="text-center">
                                <button type="submit" class="btn btn-primary"><?= ((!empty($row)) ? 'Save' : 'Add') ?></button>
                            </div>
                        </form>
                    </div>
                </div>
