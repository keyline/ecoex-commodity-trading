...
<section class="section">
    <div class="row">
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <?php if($common_model->checkModuleFunctionAccess(10,45)){?>
                        <h5 class="card-title">
                    ...
                    <table class="table datatable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if($common_model->checkModuleFunctionAccess(10,48)){?>
                                    ...
                                    <?php }?>
                                    <?php if($common_model->checkModuleFunctionAccess(10,47)){?>
                                    ...
                                    <?php }?>
                                    <?php if($row->status){?>
                                        <?php if($common_model->checkModuleFunctionAccess(10,46)){?>
                                        ...
                                        <?php }?>
                                    <?php } else {?>
                                        <?php if($common_model->checkModuleFunctionAccess(10,44)){?>
