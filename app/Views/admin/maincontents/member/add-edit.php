                    ...
                    <div class="card-body pt-3">
                        ...
                        <form method="POST" action="" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-10 col-lg-10">
                                    <input type="text" name="password" class="form-control" id="password" onkeypress="return isNumber(event)" maxlength="15" minlength="8" <?= ((!empty($row)) ? '' : 'required') ?>>
                                    <?php if ($row) { ?>
                            ...
                            <div class="row mb-3">
                                <label for="member_type" class="col-md-2 col-lg-2 col-form-label">Member Type <span class="text-danger">*</span></label>
                                <div class="col-md-10 col-lg-10">
