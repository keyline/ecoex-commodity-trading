            ...
            <div class="card">
                <div class="card-body pt-3">
                    <form method="POST" action="" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            <label for="full_address" class="col-md-2 col-lg-2 col-form-label">Vendor Address</label>
                            <div class="col-md-10 col-lg-10">
                        ...
                        <div class="row mb-3">
                            <label for="member_type" class="col-md-2 col-lg-2 col-form-label">Member Type</label>
                            <div class="col-md-10 col-lg-10">
