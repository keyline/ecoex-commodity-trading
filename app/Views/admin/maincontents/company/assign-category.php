                    ...
                    <div class="card-body pt-3">
                        <form method="POST" action="" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <?php if($userType == 'MA'){?>
                                <div class="col-md-2">
                                    <h6 class="text-success fw-bold">Select</h6>
                                </div>
                                <?php }?>
                                <div class="col-md-5">
                                    <h6 class="text-success fw-bold">Product Category</h6>
                                </div>
                                <div class="col-md-5">
                                    <h6 class="text-success fw-bold">Alias Name For <?=$company_name?></h6>
                                </div>
                            </div>
                            <?php if($cats){ foreach($cats as $cat){?>
                                ...
                                ?>
                                <div class="row" style="border:1px solid #0080003b; padding: 10px; border-radius: 5px; margin: 0; margin-bottom: 10px; display: <?=$display?>;">
                                    <?php if($userType == 'MA'){?>
                                    <div class="col-md-2">
