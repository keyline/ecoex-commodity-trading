                            ...
                            <table id="simpletable" class="table globel_table nowrap" style="width: 100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php
                                            $parentModule = $common_model->find_data('ecoex_modules', 'row', ['id' => $row->parent_id]);
                                            echo (($parentModule)?$parentModule->module_name:'');
                                            ?>
                                        </td>
                                        <td><?=$row->module_name?></td>
                                        <td>
                                            <ul style="display: flex; gap: 10px; flex-wrap: wrap; list-style: none; padding-left: 0;">
                                                <?php
