    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <?php if($common_model->checkModuleFunctionAccess(9,39)){?>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center" width="12%">
                                            ...
                                            <?php }?>
                                            <?php if($common_model->checkModuleFunctionAccess(9,41)){?>
                                            ...
                                            <?php }?>
                                            <?php if($row->status){?>
                                                <?php if($common_model->checkModuleFunctionAccess(9,40)){?>
                                                ...
                                                <?php }?>
                                            <?php } else {?>
                                                <?php if($common_model->checkModuleFunctionAccess(9,38)){?>
