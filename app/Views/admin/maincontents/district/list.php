...
<section class="section">
    <div class="row">
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <?php if($common_model->checkModuleFunctionAccess(11,51)){?>
                        <h5 class="card-title">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php }?>
                                    <?php if($common_model->checkModuleFunctionAccess(11,53)){?>
                                    ...
                                    <?php }?>
                                    <?php if($row->status){?>
                                        <?php if($common_model->checkModuleFunctionAccess(11,52)){?>
                                        ...
                                        <?php }?>
                                    <?php } else {?>
                                        <?php if($common_model->checkModuleFunctionAccess(11,50)){?>
