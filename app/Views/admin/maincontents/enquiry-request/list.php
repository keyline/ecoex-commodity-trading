                    ...
                    <table class="table datatable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a target="_blank" href="<?=base_url('admin/' . $controller_route . '/view-detail/'.encoded($row->$primary_key))?>" class="btn btn-outline-info btn-sm" title="Edit <?=$title?>"><i class="fa fa-eye"></i></a>
