                                                        ...
                                                        foreach ($enquiryProducts as $enquiryProduct) {
                                                            ...
                                                            <tr style="background-color: <?= $bgColor ?>;">
                                                                ...
                                                                <td id="set_request_item_name<?= $enquiryProduct->product_id ?>">
                                                                    <?= $productName ?>
                                                                    <!-- <span class="fw-bold <?= ($row->status == 1) ? 'edit_request_item_name' : '' ?>" data-product_id='<?= $enquiryProduct->product_id ?>' id="set_request_item_name<?= $enquiryProduct->product_id ?>"><?= $productName ?></span><br> -->
                                                                        ...
                                                                        <span class="badge bg-warning  accepted_request_edit"
                                                                            ...
                                                                            <i class="fas fa-pencil-alt"></i> Edit</span>
                                                                             <?php } if ($common_model->checkModuleFunctionAccess(23, 157)) { ?>
                                                                                <span>
                                                                                    <a href="<?= base_url('admin/' . $controller_route . '/enquiry-item/delete/' . encoded($getItem->id) . '/'. encoded($row->id)) ?>" class="badge  bg-danger btn-sm" title="Delete ?= $title ?>" onclick="return confirm('Do You Want To Delete This Item From This Enquiry ?');"><i class="fa fa-trash"></i> Delete</a>
                                                                                </span>
                                                                            <?php } ?> 
                                                                    </td>
                                                                <?php endif; ?>
                                ...
                                <div class="tab-pane fade <?= (($i == 1) ? 'show active' : '') ?>" id="subenquiry-<?= $subenquiry->id ?>" role="tabpanel" aria-labelledby="subenquiry-tab">
                                    ...
                                    <div class="accordion" id="accordionExample">
                                        ...
                                        <?php if ($common_model->checkModuleFunctionAccess(23, 134)) { ?>
                                            <?php if ($row->status >= 6 && $subenquiry->is_plant_ecoex_confirm) { ?>
                                                <div class="accordion-item">
