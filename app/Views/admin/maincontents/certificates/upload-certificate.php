                        ...
                        <!-- <form id="uploadForm" enctype="multipart/form-data">
                            ...
                            <div class="container py-4">
                                ...
                                <h5 class="card-titles mb-3">
                                    ...
                                    <strong style="margin-left:20px;">(Enquiry No: <?=$enquiry_data['enquiry_no']?>)</strong>
                                    <a target="_blank" href="<?= base_url('admin/certificates/' . $enquiry_data['id'] . '/pdf/download') ?>" download=""><button class="btn btn-download download-icon px-3">Download</button></a>
    ...
    function uploadFile(file) {
        ...
        if(total < 100){
            ...
            /* upload file into backend */
                ...
                formData.append("enquiry_id", <?=$enquiry_id?>); // Replace with dynamic enquiry_id if needed

                fetch("<?= base_url('admin/certificates/upload') ?>", {
                    method: "POST",
                    body: formData
                })
                .then(res => res.json())
