  ...
  <body style="padding: 0; margin: 0; box-sizing: border-box;">
    <section style="padding: 80px 0; height: 80vh; margin: 0 15px;">
        <div style="max-width: 600px; background: #ffffff; margin: 0 auto; border-radius: 15px; padding: 20px 15px; box-shadow: 0 0 30px -5px #ccc;">
          ...
          <div>
            <h3 style="text-align: center; font-size: 25px; color: #5c5b5b; font-family: sans-serif;">Hi, Welcome <?=(($getVendor)?$getVendor->company_name:'')?>!</h3>
            <h4 style="text-align: center; font-size: 15px; color: green; font-family: sans-serif;">Sub Enquiry Invoice Payment Approved By Ecoex Admin</h4>
            ...
            <table style="width: 100%;  border-spacing: 2px;">
              <tbody>
                ...
                <tr>
                  ...
                  <td style="padding: 10px; background: #89b33c; text-align: left; color: #fff;font-family: sans-serif;font-size: 15px; font-weight: 600;"><?=(($getVendor)?$getVendor->company_name:'')?></td>
                </tr>
                <tr>
                ...
                <tr>
                  <td colspan="2" style="padding: 10px; background: #89b33c; text-align: left; color: #fff;font-family: sans-serif;font-size: 15px; font-weight: 600; text-align:center">
                    <table cellpadding="5" cellspacing="3" style="width: 100%;  border-spacing: 2px; border-collapse:collapse;">
                      ...
                      <?php
                      $enqItems = $this->common_model->find_data('ecomm_sub_enquires', 'array', ['sub_enquiry_no' => $sub_enquiry_no]);
