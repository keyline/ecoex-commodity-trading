        ...
        <div class="row col-md-12 col-sm-12 col-xs-12">
            <div class="table-responsive">
                <table class="table table-striped table-hover table-bordered">
                    ...
                    <tbody>
                        <tr>
                            <td style="text-align:center;"><?=$request_submit_count?></td>
                            <td style="text-align:center;"><?=$request_accept_count?></td>
                            <td style="text-align:center;"><?=$request_complete_count?></td>
                        </tr>
                    </tbody>
                </table>
            </div>
