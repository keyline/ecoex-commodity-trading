...
$routes->group("admin", ["namespace" => "App\Controllers\Admin"], function ($routes) {
    ...
    $routes->match(['get', 'post'], "sub-users/access-vendor/(:any)", "AdminSubUserController::access_vendor/$1");
    /* admin sub users */
    // access & permission
    // master
    /* product category */
    ...
    $routes->match(['get', 'post'], "companies/manage-item-delete/(:any)", "CompanyController::manageItemDelete/$1");
    ...
    $routes->match(['get', 'post'], "enquiry-requests/send-whatsapp-notification-state/(:any)/(:any)", "EnquiryRequestController::sendWhatsappNotificationState/$1/$2");
    ...
    $routes->get("enquiry-requests/view-notified-recipient/(:any)/(:any)", "EnquiryRequestController::viewNotifiedRecipient/$1/$2");
    ...
    $routes->get('enquiry-report-export/pdf', 'ReportController::EnquiryReportExportPdf');
    $routes->get('enquiry-report-export/excel', 'ReportController::enquiryReportExportExcel');
    // reports
    //Subscriber list
    ...
    $routes->match(['get'], 'certificates/(:any)/pdf/preview', 'CertificateController::previewPdf/$1');
...
$routes->group("api", ["namespace" => "App\Controllers\Api",], function ($routes) {
    ...
    $routes->match(['post'], "pending-quotation-request-accept-reject-new", "ApiController::vendorPendingRequestAcceptRejectNew");
