...
// Note: The above code is a service class that handles upcoming collections and sends reminder emails.
// It connects to the database, retrieves general settings, fetches upcoming enquiries, and sends an email with the details.